...
/**
 * Uploads the single PDF inside a claim folder using ClaimDoc REST API.
 * @param {string} claimCode - Claim code (e.g., "308918125")
 * @param {string} folderPath - Folder path (e.g., C:\...\CKT147891)
...
export async function uploadClaimDoc(claimCode, folderPath) {
	try {
		...
		console.log("✅ Login successful. Access code obtained.");
